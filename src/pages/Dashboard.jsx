...
import { DEVICES, ALERTS, telemetryData, alertFreqData } from '../mock-data';
  ...
  return (
    <div>
      ...
      <div style={st.grid(4)}>
        ...
        <StatCard label="Offline" value={offline} color="#f97316" icon="⚠️" onClick={()=>nav('connectivity-offline')} sub="Need attention"/>
      </div>
      <div style={st.grid(2)}>
        <Card>
